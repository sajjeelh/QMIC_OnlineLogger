...
class DataSyncManager {
    ...
    private func sendDataToServer(data: [LoggerDataModel], attempt: Int = 0) {
    ...
    private func performChunkedRequest(with chunk: [LoggerDataModel], chunkIndex: Int, totalChunks: Int, attempt: Int = 0) {
    ...
    private func performRequest(with data: [LoggerDataModel], completion: @escaping (Bool) -> Void) {
